...
public class WrapperDemo {
	...
	public static void main(String[] args) 
	{
		// TODO Auto-generated method stub
				...
				//compareTo demo
				System.out.println("Comparing using compareTo Obj1 and Obj2: " + intObj1.compareTo(intObj2)); //compareTo is an instance method
				...
				System.out.println("Comparing using compare f1 and f2: " +Float.compare(f1,f2)); //compare is a static method
